...
- [x] check the font changes of the title/subtitle
- [x] deploy
...
- project things
  ...
  - [x] patterns on top of bgs (stripe, stars, dots, etc)
...
- filters
- maybe make users log in and see other ppls templates or what they made
